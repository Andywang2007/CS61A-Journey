...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    owndigit = player_score % 10
    if (opponent_score < 10):
        opdigit = 0
    else:
        opponent_score //= 10
        opdigit = opponent_score % 10
    dis = abs(owndigit - opdigit)
    if (dis > 0):
        return dis * 3
    else:
        return 1   
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    # BEGIN PROBLEM 4
    newsocre = simple_update(num_rolls, player_score, opponent_score, dice)
    final = sus_points(newsocre)
    return final
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    check_average = make_averaged(roll_dice,times_called)
    i = 1
    best = 1
    max_score = 0
    while i <= 10:
        currentavg = check_average(i, dice)
        if currentavg > max_score:
            max_score = currentavg
            best = i
        i += 1
    return best        
    # END PROBLEM 9
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    newpoint = boar_brawl(score, opponent_score)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    newpoint1 = sus_update(0, score, opponent_score) - score
    if newpoint1 >= threshold:
        return 0
    else:
        return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
